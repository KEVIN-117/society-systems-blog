    ...
    React.useEffect(() => {
        const fetchArticles = async () => {
            ...
            try {
                ...
                const response = await articleService.getMyArticles(currentPage, 8, filters);
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 relative z-10 gap-4">
                <div>
                    <h1 className="text-3xl font-bold font-heading text-white">
                        Mis <span className="text-gradient">Artículos</span>
                    </h1>
                    <p className="text-gray-400 mt-2">
                        Gestiona, edita y publica tus artículos en el blog.
                    </p>
                </div>

                <Link href="/dashboard/articles/create">
                    <button className="flex items-center px-6 py-2.5 bg-gradient-to-r from-[#72004c] to-[#00b4db] hover:opacity-90 text-white rounded-xl transition-all font-medium whitespace-nowrap shadow-lg shadow-[#72004c]/20">
